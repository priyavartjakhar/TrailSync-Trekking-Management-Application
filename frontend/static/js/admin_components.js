                ...
                <td>
                  <div class="batch-actions-layout">
                    ...
                    <div class="batch-actions-row">
                      ...
                      <button v-if="t.status !== 'Closed'" class="act-btn" style="background: linear-gradient(135deg, #e74c3c, #c0392b); color: white;" @click="closeBatch(t)">
                        <svg viewBox="0 0 24 24" class="act-btn-icon" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                        Close Batch
                      </button>
